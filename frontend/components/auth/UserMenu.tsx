  ...
  if (!user) {
    return (
      <div className="flex items-center gap-2">
        <Link
          href="/login"
          className="rounded-md px-3 py-2 text-sm font-medium text-vault-muted transition-colors hover:text-vault-text"
        >
          Sign in
        </Link>
        <Link
          href="/register"
          className="rounded-full bg-brand-500 px-4 py-2 text-sm font-semibold text-vault-950 transition-colors hover:bg-brand-400"
        >
          Sign up
        </Link>
      </div>
